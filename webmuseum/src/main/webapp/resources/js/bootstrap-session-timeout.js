...
//função que verifica se a sessão expirou
$.sessionTimeout({
    title: 'Sess&atilde;o Expirou!',
    message: 'Sua sess&atilde;o expirou, ser&aacute; necess&aacute;rio realizar novamente o login.',
    logoutUrl: 'Login',
    logoutButton: 'Sair',
    redirUrl: 'Login',
    keepAlive: false,
